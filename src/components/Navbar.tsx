    ...
    <nav className=" border-gray-200 px-2 sm:px-4 py-2.5  dark:bg-gray-900">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div id="menu" className="hidden w-full pl-24 md:block md:w-auto" >
          <ul className="flex flex-col p-4 mr-16 rounded-3xl  md:flex-row md:space-x-8 md:mt-0 md:text-2xl md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="/personal-projects" className="block py-2 pr-4 pl-3 text-gray-700  rounded-full hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Personal projects</a>
            </li>
            <li>
